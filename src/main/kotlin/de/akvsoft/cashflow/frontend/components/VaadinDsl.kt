...
abstract class DummyHasComponents: HasComponents {
    ...
    override fun add(components: Collection<Component>) = throw kotlin.UnsupportedOperationException("add")
    override fun getElement(): Element = throw kotlin.UnsupportedOperationException("element")
}
